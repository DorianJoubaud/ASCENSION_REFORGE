...
% precedents)
None of these approaches controls how far generation goes beyond the
learned distribution. ASCENSION's $\alpha$-scaling does, progressively
and by a tunable amount.
% ADDED FOR TMLR (AE request: covariance-based latent expansion
% precedents)
...
and agronomic data \citep{lan2025cotton}, where the expansion is
neither progressive nor tunable. Appendix~\ref{app:related-extended}
extends this discussion to further VAE variants.
