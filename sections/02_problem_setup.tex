...
% precedents)
None of these approaches controls the extent of generation beyond the
learned distribution. ASCENSION's $\alpha$-scaling does, by
progressively expanding the per-class posterior covariances while
