...
large-scale study of generative TS models and address the
degradation of generative quality on small training sets by
pretraining a diffusion model across datasets, whereas ASCENSION
augments each dataset from its own training set alone.
