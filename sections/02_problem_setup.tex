...
% precedents)
ASCENSION provides the mechanism these methods lack:
$\alpha$-scaling progressively expands the per-class posterior
covariances while preserving class identity.
% ADDED FOR TMLR (AE request: covariance-based latent expansion
% precedents)
