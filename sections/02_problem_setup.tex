...
In the data-scarce regime, \citet{gonen2025time} present the first
large-scale study of generative TS models, showing that generation
quality collapses as training sets shrink, and answer it with a
diffusion model pretrained on a large collection of datasets and
fine-tuned on the target one, whereas ASCENSION augments each
