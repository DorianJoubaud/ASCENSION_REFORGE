...
scarcity and address it with cross-dataset pretraining of a
diffusion model, whereas ASCENSION augments each dataset from its
own training set alone. The complete discussion is provided in
Appendix~\ref{app:related-extended}.
