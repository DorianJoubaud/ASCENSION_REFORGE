...
small steps that the Bayes-region filter keeps in-class. Appendix~\ref{app:budget-matched}
separates this from the effect of the total budget, by comparing
several iterations against a single one at a fixed number of generated
samples.
