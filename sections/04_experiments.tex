...
FCN (Fully Convolutional Network) as top UCR performers, we use these
architectures as introduced for TS classification by \citep{wang2017time}. We also evaluate
