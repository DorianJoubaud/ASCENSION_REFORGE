...
training data is scarcest. An ablation study confirms that the
$\alpha$-scaling mechanism is the single most impactful component
of the method. These results position ASCENSION as a low-risk
augmentation default across the heterogeneous domains of the UCR
archive, without requiring prior knowledge of method suitability.
