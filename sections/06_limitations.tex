% -----------------------------------------------------------------
% Compact L&FW section, mirroring Mai & Lin (TMLR 2026, §6) — four
...
configuration ($\alpha = 1.5$, one iteration, the default of our
implementation) while the baselines
...
TS to other input domains, since only the input and output layers
are domain-specific. We have evaluated neither extension and claim no
