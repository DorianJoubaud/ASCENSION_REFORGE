...
scarcity and address it with a diffusion model pretrained on a large
collection of TS datasets. Their findings corroborate ours, since
generative quality degrades precisely in the scarce regime where
augmentation is most needed, but their answer is cross-dataset
pretraining, whereas ASCENSION augments each dataset from its own
training set alone.
