...
filters them with the Bayes-region filter to preserve class identity,
...
\citet{gonen2025time} present the first large-scale study of
generative TS models under data scarcity: the generation quality of models trained on the target
