...
This section reports the net accuracy change per dataset domain, aggregated into the five macro-domains defined in Appendix~\ref{app:domain-coverage} (\tablename~\ref{Tab:Macro_all}). The raw UCR domain of every dataset is given in \tablename~\ref{tab:datasets_types}.
% ADDED FOR TMLR (rebuttal C4)
Values are computed on the same three fixed-configuration runs as \tablename~\ref{tab:main-results}, so weighting the macro-domain rows by their dataset counts recovers its Total column. The per-dataset spread behind these averages is reported in Appendix~\ref{app:per-dataset-std}.
...
\begin{table}[!htbp]
\centering
\caption{Macro-domain breakdown of the net accuracy change ($\overline{\Delta\mathrm{Acc}}$, percentage points) under the single fixed configuration of \tablename~\ref{tab:main-results}, as mean over the three runs with the standard deviation as a subscript. Each cell averages over every dataset of the macro-domain, so datasets left unchanged contribute $0$, and weighting the five columns by their dataset counts returns the Total column of \tablename~\ref{tab:main-results}. Macro-domains group the 11 raw UCR types as follows: Industrial = Sensor + Device + Simulated + Power, Spectral = Spectro + Spectrum, Biomedical = ECG + EPG + EOG, Image and Motion are unchanged. \textbf{Bold} marks the best method per column.}
\label{Tab:Macro_all}
...
\midrule
\multirow{9}{*}{\rotatebox{90}{ResNet}} & \textbf{ASCENSION} & $\mathbf{+0.6}_{0.4}$ & $\mathbf{+1.8}_{0.5}$ & $\mathbf{+1.3}_{1.3}$ & $\mathbf{+2.5}_{3.4}$ & $\mathbf{+1.1}_{1.3}$ \\
 & Diffusion-TS & $-2.0_{2.5}$ & $-2.2_{5.5}$ & $-1.8_{2.7}$ & $-3.8_{2.5}$ & $-3.3_{6.5}$ \\
 & FAA & $-0.9_{1.5}$ & $-1.4_{2.6}$ & $-2.6_{4.4}$ & $-1.9_{5.4}$ & $-2.6_{8.2}$ \\
 & ImagenTime & $-1.3_{2.0}$ & $-1.2_{3.1}$ & $-1.5_{1.6}$ & $-2.0_{1.4}$ & $-2.1_{4.5}$ \\
 & KoVAE & $-0.6_{0.8}$ & $+0.6_{0.7}$ & $+0.1_{0.3}$ & $-2.2_{1.3}$ & $0.0_{0.7}$ \\
 & LA & $-0.3_{0.8}$ & $-1.1_{1.7}$ & $-1.3_{2.2}$ & $-1.5_{1.0}$ & $-0.4_{2.5}$ \\
 & Time-DDPM & $-3.3_{6.8}$ & $-3.6_{5.7}$ & $-5.0_{0.5}$ & $-1.6_{7.7}$ & $-4.2_{2.2}$ \\
 & TTS-GAN & $-1.6_{0.6}$ & $-1.3_{1.4}$ & $-12.0_{1.1}$ & $-5.6_{2.0}$ & $-6.9_{1.3}$ \\
 & VaDE & $-1.0_{1.8}$ & $-0.7_{0.9}$ & $-0.2_{0.3}$ & $+0.3_{3.1}$ & $-2.2_{4.1}$ \\
\midrule
\multirow{9}{*}{\rotatebox{90}{FCN}} & \textbf{ASCENSION} & $\mathbf{0.0}_{0.8}$ & $\mathbf{+0.8}_{0.5}$ & $-0.4_{0.3}$ & $\mathbf{+2.2}_{3.8}$ & $+1.5_{2.2}$ \\
 & Diffusion-TS & $-1.7_{1.5}$ & $-3.2_{6.9}$ & $-2.2_{2.8}$ & $-1.1_{1.3}$ & $-2.8_{7.2}$ \\
 & FAA & $-3.0_{4.1}$ & $-5.1_{8.0}$ & $-4.0_{4.9}$ & $-4.9_{8.2}$ & $-3.9_{10.8}$ \\
 & ImagenTime & $-0.5_{0.4}$ & $-1.1_{0.2}$ & $-1.4_{0.5}$ & $-0.3_{0.9}$ & $\mathbf{+2.0}_{1.7}$ \\
 & KoVAE & $-1.0_{0.6}$ & $+0.2_{0.2}$ & $-0.5_{0.6}$ & $-0.9_{1.7}$ & $+0.5_{1.4}$ \\
 & LA & $-0.3_{0.4}$ & $-0.3_{0.4}$ & $0.0_{1.3}$ & $0.0_{1.4}$ & $+0.2_{0.8}$ \\
 & Time-DDPM & $-7.8_{4.1}$ & $-9.3_{3.2}$ & $-8.5_{6.9}$ & $-0.4_{5.8}$ & $-8.9_{4.9}$ \\
 & TTS-GAN & $-2.0_{0.7}$ & $-4.4_{2.3}$ & $-11.1_{2.7}$ & $-4.8_{1.2}$ & $-5.5_{0.6}$ \\
 & VaDE & $-1.3_{0.9}$ & $-1.0_{0.5}$ & $\mathbf{0.0}_{0.9}$ & $+0.7_{0.6}$ & $-1.3_{4.3}$ \\
\midrule
\multirow{9}{*}{\rotatebox{90}{Moment}} & \textbf{ASCENSION} & $+0.8_{0.9}$ & $\mathbf{+1.0}_{1.5}$ & $\mathbf{-0.4}_{0.5}$ & $\mathbf{+1.0}_{1.4}$ & $\mathbf{+1.9}_{1.4}$ \\
 & Diffusion-TS & $-2.4_{1.9}$ & $-3.2_{2.8}$ & $-1.6_{0.7}$ & $-3.5_{2.9}$ & $-2.8_{3.1}$ \\
 & FAA & $\mathbf{+1.1}_{0.9}$ & $-1.2_{0.2}$ & $-4.5_{2.9}$ & $-2.1_{4.7}$ & $+1.6_{1.4}$ \\
 & ImagenTime & $-1.1_{2.1}$ & $-1.8_{0.8}$ & $-1.9_{0.9}$ & $-4.2_{2.9}$ & $-1.7_{2.4}$ \\
 & KoVAE & $-2.2_{1.0}$ & $-3.5_{3.4}$ & $-6.9_{8.9}$ & $-5.4_{1.0}$ & $-3.3_{3.6}$ \\
 & LA & $-2.1_{0.2}$ & $-4.1_{1.5}$ & $-2.6_{0.2}$ & $-2.9_{1.9}$ & $-0.4_{3.4}$ \\
 & Time-DDPM & $-1.4_{0.3}$ & $-2.7_{0.8}$ & $-2.1_{1.0}$ & $-2.9_{0.8}$ & $-5.2_{7.2}$ \\
 & TTS-GAN & $-1.0_{0.7}$ & $-1.6_{2.2}$ & $-1.3_{1.2}$ & $-3.2_{1.6}$ & $-1.0_{0.9}$ \\
 & VaDE & $-0.9_{0.5}$ & $-0.6_{0.7}$ & $-0.6_{0.6}$ & $-1.7_{0.9}$ & $-3.6_{6.6}$ \\
\bottomrule
\end{tabular}}
\end{table}
