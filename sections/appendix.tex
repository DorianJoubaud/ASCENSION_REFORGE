...
% ADDED FOR TMLR (rebuttal C4)
The net change is positive on all five macro-domains for ResNet, on four for Moment and on three for FCN. It is negative only on Motion, under FCN and Moment, and on Industrial under FCN, where it stays within $0.05$ points of zero. Three runs are not enough to order the macro-domains against each other: the two largest gains, Spectral under ResNet and under FCN, are also the two noisiest, at $+2.47\,(3.44)$ and $+2.20\,(3.80)$, and in $11$ of the $15$ cells the standard deviation exceeds the gain itself, so the emphasis in \tablename~\ref{Tab:Macro_all} marks the largest mean rather than a resolved ranking. \tablename~\ref{Tab:Macro_methods} gives the same net change for the nine DA methods, for readers who want the per-domain comparison behind \tablename~\ref{tab:main-results}. The per-dataset spread behind these averages is reported in Appendix~\ref{app:per-dataset-std}.
...
\begin{table}[!htbp]
\centering
\caption{Net accuracy change ($\overline{\Delta\mathrm{Acc}}$, percentage points) per macro-domain for the nine DA methods, under the single fixed configuration and the three runs of \tablename~\ref{tab:main-results}, as mean\,(std) over the runs. Each cell averages over every dataset of the macro-domain, so datasets left unchanged contribute $0$, and weighting the five columns by their dataset counts returns the Total column of \tablename~\ref{tab:main-results}. The ASCENSION rows are the last column of \tablename~\ref{Tab:Macro_all}. \textbf{Bold} and \underline{underline} mark the best and second-best method per column.}
\label{Tab:Macro_methods}
{\footnotesize\setlength{\tabcolsep}{4.5pt}%
\begin{tabular}{@{}llrrrrr@{}}
\toprule
& \textbf{DA method} & \textbf{Industrial}\,(36) & \textbf{Image}\,(30) & \textbf{Motion}\,(14) & \textbf{Spectral}\,(12) & \textbf{Biomedical}\,(10) \\
\midrule
\multirow{9}{*}{\rotatebox{90}{ResNet}} & \textbf{ASCENSION} & \textbf{+0.60\,(0.40)} & \textbf{+1.76\,(0.52)} & \textbf{+1.26\,(1.30)} & \textbf{+2.47\,(3.44)} & \textbf{+1.10\,(1.25)} \\
 & Diffusion-TS & -2.00\,(2.52) & -2.18\,(5.54) & -1.81\,(2.69) & -3.77\,(2.47) & -3.28\,(6.45) \\
 & FAA & -0.87\,(1.48) & -1.38\,(2.59) & -2.62\,(4.36) & -1.89\,(5.36) & -2.56\,(8.16) \\
 & ImagenTime & -1.30\,(2.04) & -1.24\,(3.12) & -1.51\,(1.63) & -2.01\,(1.44) & -2.05\,(4.55) \\
 & KoVAE & -0.64\,(0.84) & \underline{+0.57\,(0.74)} & \underline{+0.05\,(0.33)} & -2.24\,(1.34) & \underline{-0.02\,(0.67)} \\
 & LA & \underline{-0.26\,(0.81)} & -1.11\,(1.75) & -1.31\,(2.20) & -1.46\,(0.96) & -0.44\,(2.53) \\
 & Time-DDPM & -3.27\,(6.76) & -3.62\,(5.66) & -4.97\,(0.52) & -1.56\,(7.70) & -4.19\,(2.20) \\
 & TTS-GAN & -1.60\,(0.58) & -1.31\,(1.40) & -12.04\,(1.09) & -5.65\,(1.98) & -6.86\,(1.29) \\
 & VaDE & -1.00\,(1.76) & -0.69\,(0.87) & -0.20\,(0.30) & \underline{+0.33\,(3.08)} & -2.15\,(4.13) \\
\midrule
\multirow{9}{*}{\rotatebox{90}{FCN}} & \textbf{ASCENSION} & \textbf{-0.05\,(0.84)} & \textbf{+0.77\,(0.53)} & -0.42\,(0.26) & \textbf{+2.20\,(3.80)} & \underline{+1.45\,(2.24)} \\
 & Diffusion-TS & -1.68\,(1.50) & -3.20\,(6.91) & -2.21\,(2.85) & -1.12\,(1.29) & -2.76\,(7.23) \\
 & FAA & -3.04\,(4.12) & -5.10\,(8.01) & -3.98\,(4.93) & -4.91\,(8.21) & -3.91\,(10.83) \\
 & ImagenTime & -0.54\,(0.43) & -1.08\,(0.16) & -1.36\,(0.51) & -0.25\,(0.86) & \textbf{+2.04\,(1.70)} \\
 & KoVAE & -1.04\,(0.65) & \underline{+0.23\,(0.21)} & -0.51\,(0.60) & -0.89\,(1.68) & +0.47\,(1.40) \\
 & LA & \underline{-0.30\,(0.37)} & -0.31\,(0.44) & \underline{-0.02\,(1.30)} & +0.02\,(1.40) & +0.21\,(0.85) \\
 & Time-DDPM & -7.84\,(4.12) & -9.29\,(3.24) & -8.51\,(6.93) & -0.37\,(5.80) & -8.92\,(4.92) \\
 & TTS-GAN & -1.95\,(0.72) & -4.42\,(2.33) & -11.06\,(2.73) & -4.77\,(1.17) & -5.50\,(0.59) \\
 & VaDE & -1.32\,(0.85) & -1.03\,(0.49) & \textbf{+0.04\,(0.90)} & \underline{+0.68\,(0.55)} & -1.27\,(4.34) \\
\midrule
\multirow{9}{*}{\rotatebox{90}{Moment}} & \textbf{ASCENSION} & \underline{+0.85\,(0.87)} & \textbf{+0.96\,(1.46)} & \textbf{-0.41\,(0.49)} & \textbf{+1.04\,(1.42)} & \textbf{+1.88\,(1.40)} \\
 & Diffusion-TS & -2.41\,(1.86) & -3.17\,(2.83) & -1.56\,(0.67) & -3.46\,(2.89) & -2.78\,(3.07) \\
 & FAA & \textbf{+1.10\,(0.95)} & -1.23\,(0.24) & -4.45\,(2.88) & -2.13\,(4.66) & \underline{+1.61\,(1.40)} \\
 & ImagenTime & -1.07\,(2.05) & -1.83\,(0.80) & -1.89\,(0.89) & -4.23\,(2.95) & -1.72\,(2.39) \\
 & KoVAE & -2.22\,(1.05) & -3.49\,(3.40) & -6.87\,(8.92) & -5.45\,(0.96) & -3.26\,(3.58) \\
 & LA & -2.10\,(0.18) & -4.10\,(1.54) & -2.56\,(0.20) & -2.93\,(1.86) & -0.40\,(3.38) \\
 & Time-DDPM & -1.41\,(0.29) & -2.69\,(0.80) & -2.13\,(1.05) & -2.87\,(0.78) & -5.19\,(7.24) \\
 & TTS-GAN & -1.05\,(0.68) & -1.63\,(2.22) & -1.30\,(1.20) & -3.24\,(1.59) & -1.00\,(0.85) \\
 & VaDE & -0.86\,(0.48) & \underline{-0.56\,(0.70)} & \underline{-0.62\,(0.55)} & \underline{-1.75\,(0.88)} & -3.57\,(6.56) \\
\bottomrule
\end{tabular}}
\end{table}
