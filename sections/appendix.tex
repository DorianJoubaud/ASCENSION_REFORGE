...
The configuration selected for each dataset, together with its
corresponding accuracy improvement, is listed per classifier in
\tablename~\ref{Tab:app:bestconfig}.
...
results is given in the main text
...
\begin{description}\setlength{\itemsep}{1pt}
    ...
    \item[\textbf{F20}: \texttt{SC\_FluctAnal\_2\_dfa\_50\_1\_2\_logi\_prop}] Proportion of slower timescale fluctuations that scale with detrended fluctuation analysis (DFA) under 50
