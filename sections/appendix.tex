...
for TS have appeared, including \textbf{ASE-DDPM}
...
directions for image classification, and \citet{wang2020data} augment
speaker embeddings with deep generative models. Covariance-based
sampling is also used outside classification: \citet{lan2025cotton}
sample from the Gaussian statistics of agronomic data before
encoding them with a VAE for yield regression. The first two
operate in a feature space and the third in the input space, and
all three apply a single expansion step,
...
dataset alone shows a substantial gap between the full-data and
data-scarce regimes, precisely where augmentation is most needed. Their answer transfers
...
% ADDED FOR TMLR (rebuttal C4)
The net change is positive on all five macro-domains for ResNet, on four for Moment and on three for FCN. It is negative only on Motion, under FCN and Moment, and on Industrial under FCN, where it stays within $0.05$ points of zero. Three runs are not enough to order the macro-domains against each other: the two largest gains, Spectral under ResNet and under FCN, are also the two noisiest, at $+2.47\,(3.44)$ and $+2.20\,(3.80)$, and in $10$ of the $15$ cells the standard deviation exceeds the gain itself, so the emphasis in \tablename~\ref{Tab:Macro_all} marks the largest mean rather than a resolved ranking. \tablename s~\ref{Tab:MeanImprov_ResNet}--\ref{Tab:MeanNegative_Moment} break the nine DA methods down over the same macro-domains, separating the datasets each method improves from those it worsens. The per-dataset spread behind these averages is reported in Appendix~\ref{app:per-dataset-std}.
...
\begin{table}[!htb]
\centering
\caption{Net accuracy change ($\overline{\Delta\mathrm{Acc}}$, accuracy points) of ASCENSION per macro-domain, under the single fixed configuration and the three runs of \tablename~\ref{tab:main-results}, as mean\,(std) over the runs. Each cell averages over every dataset of the macro-domain, so datasets left unchanged contribute $0$, and weighting the five rows by their dataset counts returns the ASCENSION row of the Total column of \tablename~\ref{tab:main-results}. \textbf{Bold} and \underline{underline} mark the best and second-best macro-domain per classifier.}
\label{Tab:Macro_all}
{\footnotesize
\begin{tabular}{@{}lrrr@{}}
\toprule
\textbf{Macro-domain} ($n$) & \textbf{ResNet} & \textbf{FCN} & \textbf{Moment} \\
\midrule
Industrial (36) & +0.60\,(0.40) & -0.05\,(0.84) & +0.85\,(0.87) \\
Image (30) & \underline{+1.76\,(0.52)} & +0.77\,(0.53) & +0.96\,(1.46) \\
Motion (14) & +1.26\,(1.30) & -0.42\,(0.26) & -0.41\,(0.49) \\
Spectral (12) & \textbf{+2.47\,(3.44)} & \textbf{+2.20\,(3.80)} & \underline{+1.04\,(1.42)} \\
Biomedical (10) & +1.10\,(1.25) & \underline{+1.45\,(2.24)} & \textbf{+1.88\,(1.40)} \\
\bottomrule
\end{tabular}}
\end{table}
...
\midrule
Industrial (36) & \textbf{18.7} & \textbf{2.5\,(0.5)} & 13.7 & 1.5\,(0.5) & 12.3 & 4.3\,(3.2) & 14.0 & 1.4\,(0.6) & 13.7 & 1.6\,(0.4) & 11.7 & 2.5\,(0.7) & 13.7 & 6.8\,(5.2) & 15.0 & 1.9\,(0.1) & 14.0 & 2.0\,(0.5) \\
...
Spectral (12) & \textbf{6.0} & \textbf{6.9\,(3.2)} & 3.0 & 2.8\,(0.8) & 4.3 & 6.3\,(2.0) & 3.3 & 2.5\,(1.0) & 4.0 & 2.7\,(0.7) & 3.3 & 2.8\,(0.5) & 3.7 & 14.2\,(9.3) & 2.3 & 4.4\,(2.2) & 4.7 & 5.0\,(1.5) \\
Biomedical (10) & \textbf{5.0} & \textbf{3.6\,(1.0)} & 4.7 & 1.1\,(0.2) & 4.0 & 7.3\,(6.3) & 4.7 & 1.6\,(0.5) & 4.0 & 1.8\,(0.4) & 2.7 & 5.1\,(2.5) & 4.0 & 8.3\,(11.6) & 3.0 & 1.2\,(0.7) & 2.7 & 2.1\,(1.3) \\
\bottomrule
\end{tabular}}}
\end{table}
...
\cmidrule(r){2-3} \cmidrule(r){4-5} \cmidrule(r){6-7} \cmidrule(r){8-9} \cmidrule(r){10-11} \cmidrule(r){12-13} \cmidrule(r){14-15} \cmidrule(r){16-17} \cmidrule(r){18-19}
 & Nb & $\Delta$ & Nb & $\Delta$ & Nb & $\Delta$ & Nb & $\Delta$ & Nb & $\Delta$ & Nb & $\Delta$ & Nb & $\Delta$ & Nb & $\Delta$ & Nb & $\Delta$ \\
\midrule
Industrial (36) & 12.0 & -2.2\,(0.9) & 18.0 & -4.8\,(2.6) & 18.7 & -3.5\,(2.1) & 18.3 & -3.4\,(1.6) & 16.0 & -2.6\,(1.5) & \textbf{19.3} & \textbf{-1.9\,(0.7)} & 20.0 & -7.8\,(9.7) & 16.3 & -5.4\,(1.3) & 14.0 & -4.0\,(2.6) \\
...
Spectral (12) & \textbf{4.3} & \textbf{-2.6\,(1.5)} & 7.3 & -7.6\,(3.9) & 5.7 & -7.6\,(9.5) & 7.0 & -4.5\,(1.3) & 6.7 & -5.6\,(1.5) & 6.3 & -4.1\,(1.4) & 8.0 & -12.0\,(3.8) & 7.7 & -10.0\,(3.1) & 4.7 & -4.1\,(2.4) \\
Biomedical (10) & \textbf{2.7} & \textbf{-1.6\,(0.7)} & 3.3 & -6.4\,(7.9) & 3.3 & -8.3\,(11.7) & 3.3 & -4.8\,(5.2) & 3.3 & -1.8\,(0.7) & 5.0 & -3.1\,(4.0) & 4.7 & -14.7\,(9.6) & 4.7 & -17.1\,(5.0) & 5.0 & -4.8\,(6.6) \\
\bottomrule
\end{tabular}}}
\end{table}
...
\cmidrule(r){2-3} \cmidrule(r){4-5} \cmidrule(r){6-7} \cmidrule(r){8-9} \cmidrule(r){10-11} \cmidrule(r){12-13} \cmidrule(r){14-15} \cmidrule(r){16-17} \cmidrule(r){18-19}
 & Nb & $\Delta$ & Nb & $\Delta$ & Nb & $\Delta$ & Nb & $\Delta$ & Nb & $\Delta$ & Nb & $\Delta$ & Nb & $\Delta$ & Nb & $\Delta$ & Nb & $\Delta$ \\
\midrule
Industrial (36) & 14.7 & 1.9\,(0.8) & 12.7 & 2.0\,(0.7) & 7.7 & 4.1\,(2.5) & \textbf{15.3} & \textbf{1.7\,(0.2)} & 12.0 & 1.3\,(0.5) & 12.7 & 2.0\,(0.4) & 7.0 & 9.0\,(9.2) & 12.3 & 1.7\,(0.5) & 10.7 & 2.0\,(0.7) \\
...
Spectral (12) & \textbf{6.3} & \textbf{6.3\,(3.4)} & 4.3 & 5.7\,(2.7) & 3.7 & 6.2\,(3.3) & 4.7 & 4.7\,(0.3) & 4.7 & 3.7\,(1.4) & 4.7 & 4.6\,(1.5) & 3.7 & 14.9\,(13.9) & 4.3 & 3.6\,(0.5) & 5.7 & 4.8\,(1.3) \\
Biomedical (10) & 4.3 & 4.9\,(4.2) & 3.3 & 5.5\,(0.8) & 3.0 & 5.1\,(4.6) & \textbf{4.7} & \textbf{5.9\,(1.8)} & 4.0 & 4.8\,(2.4) & 4.3 & 2.9\,(0.3) & 1.0 & 6.7\,(11.6) & 4.0 & 3.5\,(1.1) & 3.3 & 5.1\,(3.5) \\
\bottomrule
\end{tabular}}}
\end{table}
...
\cmidrule(r){2-3} \cmidrule(r){4-5} \cmidrule(r){6-7} \cmidrule(r){8-9} \cmidrule(r){10-11} \cmidrule(r){12-13} \cmidrule(r){14-15} \cmidrule(r){16-17} \cmidrule(r){18-19}
 & Nb & $\Delta$ & Nb & $\Delta$ & Nb & $\Delta$ & Nb & $\Delta$ & Nb & $\Delta$ & Nb & $\Delta$ & Nb & $\Delta$ & Nb & $\Delta$ & Nb & $\Delta$ \\
\midrule
Industrial (36) & 12.7 & -2.4\,(1.3) & 19.3 & -4.7\,(4.2) & 23.0 & -5.3\,(5.2) & 16.0 & -2.9\,(0.4) & 19.0 & -2.8\,(1.1) & \textbf{17.3} & \textbf{-2.0\,(0.3)} & 28.0 & -13.2\,(9.1) & 18.3 & -5.0\,(0.1) & 16.7 & -4.2\,(1.8) \\
...
Spectral (12) & 4.0 & -3.8\,(2.8) & 6.3 & -5.9\,(3.0) & 7.7 & -9.1\,(11.5) & 5.3 & -4.7\,(0.5) & 5.7 & -4.9\,(0.7) & 4.7 & -4.6\,(0.3) & 7.0 & -12.4\,(5.4) & 5.3 & -13.6\,(2.0) & \textbf{4.7} & \textbf{-3.7\,(1.7)} \\
Biomedical (10) & 3.0 & -4.2\,(2.8) & 4.3 & -8.5\,(7.1) & 4.7 & -9.2\,(9.9) & 3.3 & -3.2\,(3.1) & 3.3 & -3.9\,(1.4) & \textbf{3.3} & \textbf{-3.1\,(1.0)} & 7.7 & -14.2\,(1.0) & 4.0 & -17.3\,(0.6) & 4.0 & -4.4\,(6.6) \\
\bottomrule
\end{tabular}}}
\end{table}
...
\cmidrule(r){2-3} \cmidrule(r){4-5} \cmidrule(r){6-7} \cmidrule(r){8-9} \cmidrule(r){10-11} \cmidrule(r){12-13} \cmidrule(r){14-15} \cmidrule(r){16-17} \cmidrule(r){18-19}
 & Nb & $\Delta$ & Nb & $\Delta$ & Nb & $\Delta$ & Nb & $\Delta$ & Nb & $\Delta$ & Nb & $\Delta$ & Nb & $\Delta$ & Nb & $\Delta$ & Nb & $\Delta$ \\
\midrule
Industrial (36) & 19.0 & 3.6\,(1.0) & 10.3 & 2.4\,(1.1) & \textbf{20.7} & \textbf{6.5\,(3.9)} & 12.0 & 3.7\,(2.0) & 10.3 & 4.7\,(0.4) & 13.7 & 4.6\,(1.6) & 12.3 & 3.5\,(1.1) & 14.0 & 2.7\,(1.5) & 12.7 & 2.5\,(0.9) \\
...
Spectral (12) & \textbf{6.7} & \textbf{3.5\,(0.8)} & 2.3 & 4.0\,(0.9) & 6.0 & 5.8\,(1.6) & 1.7 & 4.4\,(2.6) & 1.7 & 1.2\,(0.7) & 3.7 & 5.2\,(2.8) & 2.0 & 5.3\,(5.8) & 1.3 & 2.3\,(2.3) & 2.0 & 1.7\,(0.9) \\
Biomedical (10) & 7.0 & 3.3\,(0.6) & 3.0 & 1.8\,(1.4) & 7.0 & 4.9\,(2.4) & 3.7 & 3.2\,(0.5) & 4.3 & 2.2\,(0.2) & 5.3 & 2.9\,(1.7) & 5.3 & 1.7\,(0.2) & 4.3 & 2.1\,(0.7) & 4.7 & 1.7\,(0.3) \\
\bottomrule
\end{tabular}}}
\end{table}
...
\cmidrule(r){2-3} \cmidrule(r){4-5} \cmidrule(r){6-7} \cmidrule(r){8-9} \cmidrule(r){10-11} \cmidrule(r){12-13} \cmidrule(r){14-15} \cmidrule(r){16-17} \cmidrule(r){18-19}
 & Nb & $\Delta$ & Nb & $\Delta$ & Nb & $\Delta$ & Nb & $\Delta$ & Nb & $\Delta$ & Nb & $\Delta$ & Nb & $\Delta$ & Nb & $\Delta$ & Nb & $\Delta$ \\
\midrule
Industrial (36) & \textbf{15.7} & \textbf{-2.5\,(0.5)} & 23.0 & -4.7\,(2.1) & 14.0 & -6.5\,(2.6) & 21.7 & -3.8\,(1.6) & 24.3 & -5.4\,(2.3) & 21.3 & -6.5\,(1.1) & 22.0 & -4.3\,(0.8) & 20.0 & -3.8\,(2.0) & 19.0 & -3.3\,(1.1) \\
...
Spectral (12) & \textbf{3.3} & \textbf{-3.4\,(1.0)} & 7.3 & -6.5\,(3.7) & 5.7 & -10.8\,(9.0) & 7.7 & -7.2\,(2.9) & 8.7 & -7.8\,(0.2) & 7.0 & -7.9\,(1.1) & 8.3 & -4.9\,(0.7) & 7.3 & -5.4\,(1.6) & 7.0 & -3.5\,(1.0) \\
Biomedical (10) & \textbf{2.3} & \textbf{-1.5\,(1.3)} & 6.7 & -5.2\,(3.6) & 2.3 & -5.5\,(3.7) & 6.3 & -4.5\,(2.5) & 5.7 & -6.9\,(2.8) & 4.7 & -4.3\,(1.2) & 4.7 & -12.5\,(14.1) & 5.0 & -3.9\,(2.0) & 5.0 & -6.1\,(7.3) \\
\bottomrule
\end{tabular}}}
\end{table}
